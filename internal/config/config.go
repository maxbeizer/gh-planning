...
type TUIConfig struct {
	DefaultView string          `yaml:"default-view,omitempty" json:"defaultView,omitempty"`
	Sections    []SectionConfig `yaml:"sections,omitempty" json:"sections,omitempty"`
	AutoRefresh int             `yaml:"auto-refresh,omitempty" json:"autoRefresh,omitempty"` // seconds, 0=disabled
}

// SectionConfig describes a custom section in the list view.
type SectionConfig struct {
	Name   string `yaml:"name" json:"name"`
	Filter string `yaml:"filter,omitempty" json:"filter,omitempty"`
}

// ProjectEntry describes an additional project for the project switcher.
